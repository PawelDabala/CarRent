...
from .views import User_view, Address_view, User_add, AddressSingle_view, AddressAdd_views, Maciek_view, MaciekAdd_view, Car_view, CarAdd_view
# from .views import
...
urlpatterns = [
    ...
    path('caradd', CarAdd_view, name='car_add')
